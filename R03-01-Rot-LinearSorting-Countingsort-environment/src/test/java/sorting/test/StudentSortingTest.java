...
public class StudentSortingTest {
	...
	public void setUp() {
		...
		this.vetorNegativo = new Integer[] {3, 5, 3, 2, 4, 1, -1, -3};
	...
	public void testSort012() {
		Integer[] copy1 = Arrays.copyOf(this.vetorNegativo,vetorNegativo.length);
		implementation.sort(this.vetorNegativo);
		Arrays.sort(copy1);
		Assert.assertArrayEquals(copy1, this.vetorNegativo);
	}

	@Test
	public void testSort013() {
